    ...
    <main className="max-w-6xl mx-auto px-6 py-10">
      ...
      <section className="mb-16">
        ...
        <p className="text-lg text-gray-600 mb-6 max-w-2xl">
          Conteúdos completos sobre finanças pessoais, investimentos, economia,
          renda extra e como ganhar dinheiro na internet.
        </p>

        <Link href="/blog" className="bg-black text-white px-6 py-3 rounded-lg">
          Acessar artigos
        </Link>
      </section>
